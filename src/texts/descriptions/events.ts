export const interHallHackathon: Record<string, string> = {
  eventName: 'Inter-Hall Hackathon (16 Dec 2021)',
  eventDescription:
    'Raffles Hall held the very first Inter-Hall Hackathon, in collaboration with King-Edward IIV hall, Eusoff hall and Kent Ridge Hall.\nThe Inter-Hall Hackathon is held to foster healthy competitions, learning and relationships amongst developers of different halls.\nThe participants had the following prompt. They could work in a group of up to 4 members, to create the minimum-viable product of the solutions. Participants also had to present their ideas to the judges on the last day of the Hackathon.\nProjects can be viewed at https://nus-inter-hall-hack.devpost.com/project-gallery.',
}

export const RHAppLaunch: Record<string, string> = {
  eventName: 'RHapp Launch (1 Aug 2021)',
  eventDescription:
